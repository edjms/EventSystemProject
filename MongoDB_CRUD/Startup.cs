...
namespace MongoDB_CRUD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICityEventRepository,CityEventService>();
            services.AddScoped<IPlaceEventRepository,PlaceEventService>();
            services.AddScoped<ICommentEventRepository,CommentEventService>();
            services.AddScoped<IDetailEventRepository,DetailEventService>();
